...
bool 
graphHashMap<V, E>::is_null() const 
{ 
...
template<typename V, typename E>
std::size_t 
graphHashMap<V, E>::num_vertices() const 
{ 
  return verts_.size(); 
}
...
template<typename V, typename E>
auto
graphHashMap<V, E>::vertices() const -> vertex_range
{ 
...
template<typename V, typename E>
auto 
graphHashMap<V, E>::begin_vertices() const -> vertex_iterator 
{ 
...
template<typename V, typename E>
auto
graphHashMap<V, E>::end_vertices() const -> vertex_iterator
{ 
...
template<typename V, typename E>
bool 
graphHashMap<V, E>::is_empty() const 
{ 
  return num_edges() == 0; 
}
...
template<typename V, typename E>
std::size_t 
graphHashMap<V, E>::num_edges() const { return edges_.size(); }

// Returns the list of edges in the graph.
template<typename V, typename E>
auto 
graphHashMap<V, E>::edges() const -> edge_range
{ 
...
template<typename V, typename E>
auto 
graphHashMap<V, E>::begin_edges() const -> edge_iterator 
{ 
...
template<typename V, typename E>
auto 
graphHashMap<V, E>::end_edges() const -> edge_iterator 
{ 
...
template<typename V, typename E>
edge_list 
graphHashMap<V, E>::edges(vertex_t v) const 
{ 
...
template<typename V, typename E>
std::size_t 
graphHashMap<V, E>::degree(vertex_t v) const 
{ 
...
template<typename V, typename E>
auto
graphHashMap<V, E>::find_edge(vertex_t u, vertex_t v) const -> edge_iterator
{
...
template<typename V, typename E>
bool
graphHashMap<V, E>::has_edge(vertex_t u, vertex_t v) const
{
...
template<typename V, typename E>
edge_t
graphHashMap<V, E>::edge(vertex_t u, vertex_t v) const
{
  assert(has_edge(u, v));
...
template<typename V, typename E>
auto graphHashMap<V, E>::find_vertex(vertex_t v) const -> vertex_iterator
{
...
template<typename V, typename E>
bool
graphHashMap<V, E>::has_vertex(V const& v) const
{
...
template<typename V, typename E>
vertex_t 
graphHashMap<V, E>::first(edge_t e) const 
{ 
...
template<typename V, typename E>
vertex_t 
graphHashMap<V, E>::second(edge_t e) const 
{ 
...
template<typename V, typename E>
vertex_t
graphHashMap<V, E>::opposite(edge_t e, vertex_t v) const
{
...
template<typename V, typename E>
vertex_t
graphHashMap<V, E>::add_vertex(V const& v)
{
...
template<typename V, typename E>
bool graphHashMap<V,E>::remove_vertex(V const& v)
{
    auto iterator = find_vertex(v);

    for (E& e : verts_[v].edges_ )
    {
        remove_edge(v, e.second(), e);
    }
...
template<typename V, typename E>
edge_t
graphHashMap<V, E>::add_edge(vertex_t u, vertex_t v)
{
  assert(!has_edge(u, v));
...
template<typename V, typename E>
edge_t
graphHashMap<V, E>::add_edge(vertex_t u, vertex_t v, E const& x)
{
  assert(!has_edge(u, v));
...
template<typename V, typename E>
inline bool graphHashMap<V, E>::remove_edge(vertex_t u, vertex_t v, E const &x)
{
    //undirect graph
    verts_[u].edges_.erase(x);
    verts_[v].edges_.erase(x);
